...
package com.expagent.ui.textinputactivity
...
@Serializable
data class TextInputActivityInput(
    val title: String,
    val text: String="",
    val context: String="",
    ) {
    ...
    fun toIntent(launchingActivity: androidx.fragment.app.FragmentActivity): Intent {
        val intent=Intent(launchingActivity, TextInputActivity::class.java)
    ...
    companion object {
        ...
        fun fromIntent(intent: Intent?, caller: String): TextInputActivityInput {
            val key="input"
            ...
            if (intent!=null) {
                ...
                if (extras!=null) {
                    ...
                    try {
                        return Json.decodeFromString<TextInputActivityInput>(json)
                        }
                    catch (e: Exception) {
